...
#
# **NOTE** - completing this exercise without looking at the solution could
# take a few hours.  Be prepared and good luck!
#
# <img src="Drone2.png" width="300" height="300">
#
# In this lesson we will be working with a simplified model of the 2D drone you
# worked with in the first lesson.  We will be directly setting the vehicle's
# collective thrust through $u_1$ and the moment about the x axis, $M_x$
# through $u_2$.  We will ignore propeller rotation rates as well as the
# yaw-inducing moment $M_z$.
#
...
# Walk through this code to refamiliarize youself with how state is
...
#
# In this section, you will create the controller described in class.  The
# schematic description of the cascading controller looks like this:
# <img src="CascadingController2.png" width="800" >
#
# The controller architecture uses three **PD** controllers to control the
# drone (note that you will not need an I term for the controllers used in this
# exercise).
#
# One PD controller is used to generate the thrust and control the altitude
# while two PD controllers are used to control the lateral motion.  The first
# receives the desired lateral position information containing $y$ , $\dot{y}$
# and (optionally) $\ddot{y}$.  Using this information as well as the current
# vehicle state, it outputs the commanded $\phi$ roll angle.
#
# The second PD controller is used to set a torque value $M_x$ to achieve the
# desired angle.  In most cases, the inner controller responsible for roll
# angle operates at a higher frequency than the ones that are used to control
# the position.
...
# implementing `attitude_controller`.
#
...
#
# > NOTE - you can find the code that generates this trajectory in the file
# called `trajectories.py`, which you can access by clicking on the Jupyter
# logo in the top left corner of this notebook.
