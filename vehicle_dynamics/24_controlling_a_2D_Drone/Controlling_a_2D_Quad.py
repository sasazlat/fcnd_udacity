...
# In this exercise you will implement two new methods.  These could be
# difficult OR if you use your existing code effectively they could be pretty
# straightforward.
#
# First you will implement `advance_state` for the controlled 2D drone.
#
# Then you will implement `set_rotors_angular_velocities` **for the 1D case!**
# At the end of this notebook we will try to follow a sinusoidally oscillating
# vertical trajectory.
