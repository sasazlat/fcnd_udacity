...
# * $z$ -> ALTITUDE (+)
#
# Each $(x, y, z)$ coordinate is the center of the obstacle.  $\delta x$,
...
# \delta y = 5, \delta z = 8)$ is a 10 x 10 m obstacle that is 16 m high and
# centered at the point $(37, 12, 8)$.
#
...
# 3 dimensional configuration space.  Your task is to extract a 2D map of your
