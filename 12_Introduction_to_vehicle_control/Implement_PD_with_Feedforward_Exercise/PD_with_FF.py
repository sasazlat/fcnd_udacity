...
# # Feedforward control
#
# The feedforward term captures the acceleration of the target path and adds to
# the $\bar{u}_1$ calculated by PD controller.
#
# $$
...
#
# Modify `thrust_control` to incorporate the feedforward term into the PD
# Controller math.
#
# $$
# \begin{align}
...
#
# The code below generates plots of $z$ vs $t$ for two drones.  One uses FF and
# the other doesn't.
#
# Run the code and compare the two trajectories.  What happens if you increase
# the oscillation frequency to 10?  What happens if you decrease it to 2?
#
# You should notice a **lag** in the system response: the trajectory without
# the feedforward term should lag behind the desired trajectory in time.  This
# effect diminishes as the oscillation frequency decreases.
